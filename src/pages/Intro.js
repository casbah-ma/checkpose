...
const TEXT = [
  ...
  },
  {
    title: "Insights ",
    description:
      "Visualization tools that help you understand your body’s strengths and weaknesses",
  },
  {
    title: "Private",
    description: "This app runs locally on your machine without internet or a server",
  },
  {
    title: "Free & Open",
    description:
  ...
  return (
    <Layout>
      <Container>
        ...
        {TEXT.map((t) => (
          <>
            <Title key={t.title}>{t.title}</Title>
